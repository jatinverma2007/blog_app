...
const BlogView = () => {
    ...
    // Show loading or not found if selectedBlog is not available
    if (!selectedBlog) {
        return (
            <div className='pt-14'>
                <div className='max-w-6xl mx-auto p-10 text-center'>
                    <h1 className='text-2xl font-bold'>Blog not found</h1>
                    <p className='text-gray-500 mt-2'>The blog you're looking for doesn't exist or has been removed.</p>
                    <Link to='/blogs'>
    ...
    const commentCount = Array.isArray(comment) ? comment.length : 0;
